...
public class GetDomesticAirlinesTimeResponse  implements java.io.Serializable {
    private com.example.client.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getDomesticAirlinesTimeResult;

    public GetDomesticAirlinesTimeResponse() {
    }

    public GetDomesticAirlinesTimeResponse(
           com.example.client.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getDomesticAirlinesTimeResult) {
     ...
     */
    public com.example.client.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getGetDomesticAirlinesTimeResult() {
        return getDomesticAirlinesTimeResult;
    }
     ...
     */
    public void setGetDomesticAirlinesTimeResult(com.example.client.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getDomesticAirlinesTimeResult) {
        this.getDomesticAirlinesTimeResult = getDomesticAirlinesTimeResult;
    }
